...
public final class FieldElementPositions {
    ...
    public static final Translation3d
        BLUE_LEFT_SUBSTATION = new Translation3d(16.381, 7.859225, 1.07),
        BLUE_RIGHT_SUBSTATION = new Translation3d(16.381, 5.647775, 1.07),
        RED_LEFT_SUBSTATION = new Translation3d(0.323, 5.647775, 1.07),
        RED_RIGHT_SUBSTATION = new Translation3d(0.323, 7.859225, 1.07);
