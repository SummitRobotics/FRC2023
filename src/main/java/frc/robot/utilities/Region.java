...
public class Region {
    ...
    public Region(Translation3d firstCorner, Translation3d secondCorner) {
        ...
        this.center = new Translation3d((firstCorner.getX() + secondCorner.getX()) / 2,
                (firstCorner.getY() + secondCorner.getY()) / 2, 
                (firstCorner.getZ() + secondCorner.getZ()) / 2);
    }
    ...
    public boolean contains(Translation3d point) {
        return point.getX() >= firstCorner.getX() && point.getX() <= secondCorner.getX() &&
                point.getY() >= firstCorner.getY() && point.getY() <= secondCorner.getY() &&
